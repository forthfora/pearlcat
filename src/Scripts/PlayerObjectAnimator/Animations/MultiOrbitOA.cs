...
public class MultiOrbitOA : ObjectAnimation
{
    ...
    public readonly Vector2 OrbitPearls_5_Offset = new(30.0f, -20.0f);
    public readonly Vector2 OrbitPearls_3_Offset = new(25.0f, 25.0f);
    public readonly Vector2 OrbitPearls_2_Offset = new(-25.0f, 30.0f);


    public const float RADIUS_5 = 15.0f;
    public const float RADIUS_3 = 10.0f;
    public const float RADIUS_2 = 5.0f;

    public const float F_ADDITION_5 = 0.06f;
    public const float F_ADDITION_3 = 0.125f;
    public const float F_ADDITION_2 = 0.2f;
