...
public class SlugcatSelectMenuModule
{
    ...
    public SlugcatSelectMenuModule(SlugcatSelectMenu self)
    {
        ...
        MiraCheckbox = new(self, self.pages[0], self, new Vector2(self.startButton.pos.x + 200f + textOffset, 90.0f), textWidth, self.Translate("Skip to Mira Storyline"), Menu_Helpers.MIRA_SKIP_ID);
