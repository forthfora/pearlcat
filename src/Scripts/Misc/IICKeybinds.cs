...
public static class IICKeybinds
{
    ...
    public static KeyCode GetSwapKeybind(bool controller) => controller ? StoreKeybind.GamepadPreset : SwapKeybind.CurrentBinding(0);
    ...
    public static KeyCode GetSwapLeftKeybind(bool controller) => controller ? StoreKeybind.GamepadPreset : SwapLeftKeybind.CurrentBinding(0);
    ...
    public static KeyCode GetSwapRightKeybind(bool controller) => controller ? StoreKeybind.GamepadPreset : SwapRightKeybind.CurrentBinding(0);
    ...
    public static KeyCode GetSentryKeybind(bool controller) => controller ? StoreKeybind.GamepadPreset : SentryKeybind.CurrentBinding(0);
    ...
    public static KeyCode GetAbilityKeybind(bool controller) => controller ? StoreKeybind.GamepadPreset : AbilityKeybind.CurrentBinding(0);
}
