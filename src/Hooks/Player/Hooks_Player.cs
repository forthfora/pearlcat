...
{
    public static void ApplyHooks_Player()
    {
        ...
        try
        {
            _ = new Hook(
                ...
                typeof(Hooks_Player).GetMethod(nameof(GetPlayerVisibilityBonus), BindingFlags.Static | BindingFlags.Public)
            );
        }
        catch (Exception e)
        {
