...
{
    public static void ApplyHooks_Pearlpup_Graphics()
    {
    ...
    private static void PlayerGraphics_DrawSpritesPearlpup(On.PlayerGraphics.orig_DrawSprites orig, PlayerGraphics self, RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, float timeStacker, Vector2 camPos)
    {
        ...
        Hooks_Player.UpdateCustomPlayerSprite(sLeaser, Hooks_Player.HEAD_SPRITE, "Head", "pearlpup_scarf", "Scarf", module.ScarfNeckSprite);
        Hooks_Player.UpdateCustomPlayerSprite(sLeaser, LEGS_SPRITE, "Legs", "feet", "Feet", module.FeetSprite);
